...
double ASL::prod(Vector v) // overloaded version 1
{
	...
	return accumulator;
} // end function prod overloaded version 1


// doesn't work on vectors with 0 elements.
double ASL::prod(TempVector v) // overloaded version 2
{
	register unsigned int c;
	register anticast p;
	register double accumulator;
	...
	return accumulator;
} // end function prod overloaded version 2

#pragma endregion
#pragma region Matrix

// doesn't work on matrices with 0 elements.
TempVector ASL::prod(Matrix A , char dim) // overloaded version 3
{
	...
	return v;
} // end function prod overloaded version 3


// doesn't work on matrices with 0 elements.
TempVector ASL::prod(TempMatrix A , char dim) // overloaded version 4
{
	register unsigned int reduceDimention,c;
	register anticast source,destination;
	register double accumulator;
	...
	return v;
} // end function prod overloaded version 4
