...
double ASL::any(Vector v) // overloaded version 1
{
	...
	return accumulator;
} // end function any overloaded version 1


// doesn't work on vectors with 0 elements.
double ASL::any(TempVector v) // overloaded version 2
{
	register unsigned int c;
	register anticast p;
	register double accumulator;
...
TempVector ASL::any(Matrix A , char dim) // overloaded version 3
{
	...
	return v;
} // end function any overloaded version 3


// doesn't work on matrices with 0 elements.
TempVector ASL::any(TempMatrix A , char dim) // overloaded version 4
{
	register unsigned int reduceDimention,c;
	register anticast source,destination;
	register double accumulator;
